...
public class ArrivalsListAdapterStyleA extends ArrivalsListAdapterBase<ArrivalInfo> {
    ...
    protected void initView(View view, ArrivalInfo stopInfo) {
        ...
        ImageView[] bikes = {
                (ImageView) view.findViewById(R.id.bikesilhouette1),
                (ImageView) view.findViewById(R.id.bikesilhouette2),
                (ImageView) view.findViewById(R.id.bikesilhouette3)
        };
        ...
        ViewGroup bikeStatusBar = view.findViewById(R.id.bike_status);
