...
public class RequestBase {
    ...
    public static class BuilderBase {
        ...
        protected boolean mIsBikeServer = false;
        ...
        // TODO figure out the right terminology here

        protected void setIsBikeServer(Boolean isBikeServer) { mIsBikeServer = isBikeServer; }
    }
